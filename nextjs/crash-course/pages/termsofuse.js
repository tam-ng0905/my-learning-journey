...
export default function TermsOfUse() {
	return (
		<div className="relative shadow-inner py-8 bg-white overflow-hidden">
			...
			<div className="relative px-4 sm:px-6 lg:px-8">
				<div className="text-sm max-w-3xl mx-auto">
					<h2 className="font-bold my-2">Terms of Use</h2>
					<p className="mb-6">
						These terms and conditions (“Agreement”) set forth the general terms
						and conditions of your use of the tarclone.com website (“Website”),
						“Tarclone” mobile application (“Mobile Application”) and any of
						their related products and services (collectively, “Services”). This
						Agreement is legally binding between you (“User”, “you” or “your”)
						and Tarclone Inc. (“Tarclone Inc.”, “we”, “us” or “our”). If you are
						...
						this Agreement. You acknowledge that this Agreement is a contract
						between you and Tarclone Inc., even though it is electronic and is
						not physically signed by you, and it governs your use of the
						Services.
					</p>
					<h2 className="font-bold my-2">Accounts and Membership</h2>
					<p className="mb-6">
					...
					<h2 className="font-bold my-2">User Content</h2>
					<p className="mb-6">
					...
					<h2 className="font-bold my-2">Billing and Payments</h2>
					<p className="mb-6">
						...
						digital signatures, and the Services are also in compliance with PCI
						...
						on a regular basis for additional security and protection. If, in
						our judgment, your purchase constitutes a high-risk transaction, we
					...
					<h2 className="font-bold my-2">Accuracy of Information</h2>
					<p className="mb-6">
					...
					<h2 className="font-bold my-2">Third Party Services</h2>
					...
					<p className="mb-6">
						...
						against Tarclone Inc. with respect to such other services. Tarclone
						Inc. is not liable for any damage or loss caused or alleged to be
						caused by or in connection with your enablement, access or use of
						...
						are expressly permitting Tarclone Inc. to disclose your data as
						necessary to facilitate the use or enablement of such other service.
					</p>

					<h2 className="font-bold my-2">Backups</h2>
					<p className="mb-6">
					...
					<h2 className="font-bold my-2">Links to Other Resources</h2>
					...
					<p className="mb-6">
						...
						do not warrant the offerings of, any businesses or individuals or
					...
					<h2 className="font-bold my-2">Prohibited Uses</h2>
					...
					<h2 className="font-bold my-2">Intellectual Property Rights</h2>
					<p className="mb-6">
						...
						you any intellectual property owned by Tarclone Inc. or third
						parties, and all rights, titles, and interests in and to such
						property will remain (as between the parties) solely with Tarclone
						Inc. All trademarks, service marks, graphics and logos used in
						connection with the Services, are trademarks or registered
						trademarks of Tarclone Inc. or its licensors. Other trademarks,
						...
						otherwise use any of Tarclone Inc. or third party trademarks.
					</p>

					<h2 className="font-bold my-2">Disclaimer of Warranty</h2>
					...
					<h2 className="font-bold my-2">Limitation of Liability</h2>
					<p className="mb-6">
						To the fullest extent permitted by applicable law, in no event will
						Tarclone Inc., its affiliates, directors, officers, employees,
						...
						law, the aggregate liability of Tarclone Inc. and its affiliates,
						...
						any amounts actually paid in cash by you to Tarclone Inc. for the
					...
					<h2 className="font-bold my-2">Indemnification</h2>

					<p className="mb-6">
						You agree to indemnify and hold Tarclone Inc. and its affiliates,
					...
					<h2 className="font-bold my-2">Severability</h2>
					...
					<h2 className="font-bold my-2">Dispute Resolution</h2>
					...
					<p className="mb-6">
						...
						and procedural laws of Colorado, United States without regard to its
						...
						located in Colorado, United States, and you hereby submit to the
					...
					<h2 className="font-bold my-2">Assignment</h2>
					...
					<h2 className="font-bold my-2">Changes and Amendments</h2>
					...
					<h2 className="font-bold my-2">Acceptance of these terms</h2>
					...
					<h2 className="font-bold my-2">Contacting Us</h2>

					<p className="mb-6">
						If you have any questions, concerns, or complaints regarding this
						Agreement, we encourage you to contact us using the details below:
					</p>
					<p className="mb-6">team@tarclone.com</p>
					<p className="mb-6">
						This document was last updated on January 23, 2022
					</p>
				</div>
			</div>
		</div>
