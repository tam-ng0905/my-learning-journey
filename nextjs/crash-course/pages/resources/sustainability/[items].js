import { getSustainabilityByName } from "../../data/resources/sustainability";
...
export default function SustainabilityDetail() {
	...
	const sustainabilityName = router.query.items; //furnanceace
	const sustainability = getSustainabilityByName(sustainabilityName);
	// console.log(sustainability);

	// if (!event) {
	//     return (
	//         <ErrorAlert>
	//             <p>No sustainability found!</p>;
	//         </ErrorAlert>
	//     )
	// }
			...
			<div className="relative px-4 sm:px-6 lg:px-8">
				<div className="text-lg max-w-prose mx-auto">
					...
					<figure>
						<Image
							...
							alt={sustainability.imageDescription}
							width={1024}
							height={512}
						/>
					</figure>
				...
				<div className="mt-8 prose prose-blue prose-lg text-gray-600 max-w-prose mx-auto">
					<h3 className="mt-4 mb-2 text-xl md:text-2xl font-semibold text-gray-800">
						{sustainability.heading_one}
					</h3>
					<p>{sustainability.paragraph_one}</p>
					<h3 className="mt-4 mb-2 text-xl md:text-2xl font-semibold text-gray-800">
						{sustainability.heading_two}
					</h3>
					<p>{sustainability.paragraph_two}</p>
					{/* Add Image Here */}
					<h3 className="mt-4 mb-2 text-xl md:text-2xl font-semibold text-gray-800">
						{sustainability.heading_three}
					</h3>
					<p>{sustainability.paragraph_three}</p>
					<h3 className="mt-4 mb-2 text-xl md:text-2xl font-semibold text-gray-800">
						{sustainability.heading_four}
					</h3>
					<p>{sustainability.paragraph_four}</p>
					<h3 className="mt-4 mb-2 text-xl md:text-2xl font-semibold text-gray-800">
						{sustainability.heading_five}
					</h3>
					<p>{sustainability.paragraph_five}</p>
